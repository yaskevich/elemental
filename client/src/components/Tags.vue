<template>
  <n-card title="Tags" :bordered="false" class="minimal left" v-if="isLoaded">
    ...
    >
      <n-space vertical>
        <n-input v-model:value="newTag.en" type="text" placeholder="English title" />
    ...
    <n-space vertical size="large" align="end">
      <n-grid x-gap="12" cols="3" responsive="screen" v-for="item in tags" :key="item.id">
        <n-gi>
